...
function checkTweets() {
    ...
    for (let i = 0; i < tweets.length; i++) {
        ...
        if (!tweet_bar.getElementsByClassName("auth-icon").length) {
            ...
            svg_icon.innerHTML = `<path fill=` + icon_colour + ` d="M23.623,0.218c-0.433-0.344-1.062-0.271-1.405,0.161L9.416,16.501l-4.207-4.207c-0.391-0.391-1.024-0.391-1.414,0
            ...
            <path fill=` + icon_colour + ` d="M18.551,11.021c-0.538,0.123-0.875,0.659-0.752,1.197c0.134,0.585,0.202,1.185,0.202,1.783c0,4.411-3.589,8-8,8
